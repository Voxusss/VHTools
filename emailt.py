...
def alias(driver):
    ...
    for i in range(10):
        ...
        time.sleep(15)
        with open('firstnames.txt') as fn:
            firsts = fn.readlines()
        l=[]
...
def imap(driver):
    ...
    with open('password.txt') as ps2:
        ps2 = ps2.readline()
        ps2=ps2.split("['")[0]
    with open("recupemail.txt", "r") as recem:
    ...
    with open("recupemail.txt", "r+") as f:
        d = f.readlines()
        f.seek(0)
        for i in d:
